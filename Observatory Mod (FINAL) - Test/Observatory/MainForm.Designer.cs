...
namespace Observatory
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            //this.Location = new Point(Screen.PrimaryScreen.Bounds.Width - this.Width, 0); Console.WriteLine("Main Form location : {0},{1}", this.Location.X, this.Location.Y);
            //this.Location = new System.Drawing.Point(System.Windows.Forms.Screen.PrimaryScreen.WorkingArea.Width-this.Width,0);
        }
