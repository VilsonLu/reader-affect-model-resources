...
{
    public partial class Annotation_3 : Form
    {
        ...
        public Annotation_3(Form parent, List<Label> l)
        {
            InitializeComponent();
            this.parent = parent;
            label = l;
        ...
        private void init()
        {
            if (label.Count == 3)
            {
                ...
                emo3Bar.Minimum = label[2].Min;
                emo3Bar.Maximum = label[2].Max;
                emo3Bar.TickFrequency = label[2].Interval;
                emo3Bar.Name = label[2].Name;
                emo3Label.Text = label[2].Name;
            }
            else
